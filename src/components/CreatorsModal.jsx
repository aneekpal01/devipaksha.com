...
export default function CreatorsModal({ isOpen, onClose }) {
  ...
  const email = 'aneekpal.dev@gmail.com';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-2xl animate-fadeIn select-none">
      <div className="relative w-full max-w-md rounded-[32px] liquid-glass-card p-5 sm:p-6 shadow-2xl border border-white/20 text-center">
        ...
        <div className="p-5 rounded-2xl bg-white/5 border border-white/15 shadow-inner flex flex-col items-center">
          ...
          <div className="relative w-20 h-20 rounded-full p-1 bg-gradient-to-tr from-amber-500 via-[#ffd873] to-rose-500 shadow-[0_0_20px_rgba(255,216,115,0.4)] mb-3 flex items-center justify-center">
            <div className="w-full h-full rounded-full bg-[#1e130c] overflow-hidden flex items-center justify-center border-2 border-[#120805]">
              <img
                src="/durga-logo.png"
                alt="Aneek Pal"
                className="w-12 h-12 object-contain filter drop-shadow-[0_0_8px_rgba(255,216,115,0.8)]"
              />
            </div>
          </div>

          {/* Name & Tagline */}
          <h3 className="text-lg sm:text-xl font-bold text-[#fdf3e2] tracking-wide">
            Aneek Pal
          </h3>
          <p className="text-xs text-[#ffd873]/90 font-medium mt-0.5 font-bengali">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full liquid-glass-btn text-[#fdf3e2] hover:text-[#0077b5] hover:border-[#0077b5]/60 hover:scale-108 active:scale-95 transition-all shadow-md cursor-pointer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 rounded-full liquid-glass-btn text-[#fdf3e2] hover:text-[#e4405f] hover:border-[#e4405f]/60 hover:scale-108 active:scale-95 transition-all shadow-md cursor-pointer"
